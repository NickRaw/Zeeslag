            ...
            if x > rij and x < rij+boxsize:
                  ...
                  while rij_niet_klaar and y_counter < aantalvakken:
                        ...
                        if y < kolom and y > kolom-boxsize:
                              ...
                              if compbord[y_coor][x_coor] != 'O':

                                    # Er zit een schip, dus rood vierkant tekenen.
                                    boxmaker(rij, kolom, "red")
                                    if bombord[y_coor][x_coor] == 'O':
                                          bombord[y_coor][x_coor] = 'X'
                                          geraakte_schepen+=1
                                          gebruikte_bommen+=1
...
def bordmaker(aantalboxen, players):
    ...
    if players == 1:
        ...
        # Slagschip plaatsen
        while not schip_plaatser('S', 5, random.randint(1,2), random.randint(0,aantalboxen-1), random.randint(0,aantalboxen-1), compbord):
            print()

        # Kruiser plaatsen
        while not schip_plaatser('K', 4,  random.randint(1,2), random.randint(0,aantalboxen-1), random.randint(0,aantalboxen-1), compbord):
            print()

        # Eerste fregat plaatsen
        while not schip_plaatser('F', 3,  random.randint(1,2), random.randint(0,aantalboxen-1), random.randint(0,aantalboxen-1), compbord):
            print()
        ...
        while not schip_plaatser('M', 2,  random.randint(1,2), random.randint(0,aantalboxen-1), random.randint(0,aantalboxen-1), compbord):
            print()
...
def keuze_1(x,y):
    ...
    bordmaker(aantalvakken, 1)
    bord()
    global start_tijd
    start_tijd = time.time()
    window.onscreenclick(bordchecker)
...
def main():
    ...
    menuknop_1_label.write('Singleplayer', True, align="center", font=("Stencil", "15"))
